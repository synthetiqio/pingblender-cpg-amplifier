...
class Robot:
    ...
    class Manage:
        ...
        async def updateSource(self):
            ...
            action= await Robot.Entity.Origin(package=self.start).updateFieldControls(fields=fields)
            return action 
    ...
    class Entity:
        ...
        class Origin:
            ...
            def bind(
                ...
                if len(sub) >=1:
                    for item in sub:
                        Robot.Update(package=self.start).editFields(set=item)
                targets=Robot.Query(lookup_key=self.sfid).getTargetFields()
                a:list=[]
                for item in targets:
                    b={
                        'id': item[0], 
        ...
        class Query:
            ...
            def __init__(
                ...
                self.lu={
                    'eo': Robot.Entity.Entry.entity_sfid,
                    'en': Robot.Entity.Entry.entity_name,
                    'el': Robot.Entity.Entry.entity_label,
                    'es': Robot.Entity.Assignment.assign_source,
                    'et': Robot.Entity.Assignment.assign_target,
                }
        ...
        class Template(Env.HasTimestamp,Control):
            ...
            Robot_assigned:Mapped[bool]=mapped_column(
                types.Boolean,
                nullable=True, 
                default=False 
            )
    ...
    def router(
        ...
        match str(transact).upper():
            ...
            case 'RETRIEVE':
                ...
                with Transact.Session() as Session:
                    try:
                        ...
                        result={                      
                                'result': 'FAILURE',
                                'message': 'this Robot could not be retrieved.', 
            ...
            case 'GENMATRIX':
                ...
                with Transact.Session() as session:
                    receiver:Dict[List,Any]=payload 
                    establish=Robot.Entity.Assignment(
                        field_index=None,
            ...
            case 'INITIATE': 
                ...
                with Transact.Session() as session:
                    ...
                    format=Robot.Entity.Assignment(
                        field_index=None, 
